...
static struct snd_soc_dai_link soc_dais[] = {
    [0] = {
        .name = "m5sthird akm4490",
        .stream_name = "m5sthird akm4490",
        .platform_name = "jz-asoc-aic-dma",
       	.cpu_dai_name = "jz-asoc-aic-i2s",
        .init = i2s_dai_link_init,
        .codec_dai_name = "akm4493-dai",
        .codec_name = "akm4493left.1-0012",
        .ops = &beethoven_i2s_ops,
    },
	[1] = {
        .name = "m5sthird PCMBT",
        .stream_name = "m5sthird PCMBT",
