...
#define CAMERA_FRONT_SENSOR_PWDN        GPIO_PA(20)
...
#define GPIO_LCD_BACKLIGHT              GPIO_PB(19)
#define GPIO_LCD_PWM                    (-1)
#endif
...
#define GPIO_CYPRESS_PSOC4_INT    GPIO_PB(30)
#define GPIO_CYPRESS_PSOC4_RST    GPIO_PC(7)
