...
#define OEMINFO_SIZE                    0x20000                     /* 128K */
#define OEMINFO_OFFSET                  KERNEL_OFFSET +  KERNEL_SIZE
#define USERFS_SIZE                     0xC80000                    /* 12.5M */
#define USERFS_OFFSET                   0x360000                    /* 3.5M */
#endif /* end of #ifdef CONFIG_SUPPORT_OTA */
...
#define SIZE_OEMINFO 0x80000    /* 512K */
...
#if ( ( (defined(CONFIG_JZ_SPI0) || defined(CONFIG_SPI_GPIO)) && defined(CONFIG_JZ_SPI_NOR) ) || \
        (defined(CONFIG_JZ_SFC) && defined(CONFIG_JZ_SFC_NOR) ) )
...
#endif	/* condition defined(CONFIG_JZ_SPI_NOR) || defined(CONFIG_JZ_SFC_NOR) */
...
#endif  /* defined(CONFIG_JZ_SPI0) || defined(CONFIG_SPI_GPIO) */
...
struct jz_spi_info spi0_info_cfg = {
    ...
    .num_chipselect         = 1,
    .allow_cs_same          = 1,
    .chipselect             = {SPI0_CHIP_SELECT0, SPI0_CHIP_SELECT1,},
#ifdef CONFIG_JZ_SPI_BOARD_INFO_REGISTER
