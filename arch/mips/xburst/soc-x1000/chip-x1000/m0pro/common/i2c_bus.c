...
add by zxj
**/
#if defined(CONFIG_SND_ASOC_INGENIC_ES9118) || defined(CONFIG_SND_ASOC_INGENIC_ES9218)
...
#endif
#ifdef CONFIG_MFD_AXP2101_I2C
	{
		I2C_BOARD_INFO("x-powers,axp2101", 0x34),	//seven bit 0x34
		.platform_data	= NULL,
	},
#endif
};
...
#ifdef CONFIG_SND_ASOC_INGENIC_ES9118
	{
		I2C_BOARD_INFO("es9118", 0x48),	//seven bit 0x48 eight bit 0x90
		.platform_data	= &es9118_platform_data,
	},
#endif
#ifdef CONFIG_SND_ASOC_INGENIC_ES9218
	{
		I2C_BOARD_INFO("es9218", 0x48),	//seven bit 0x48 eight bit 0x90
		.platform_data	= &es9118_platform_data,
	},
#endif
#ifdef CONFIG_SND_ASOC_INGENIC_ES9219
	{
		I2C_BOARD_INFO("es9219_1", 0x48),	//seven bit 0x48 eight bit 0x90
		.platform_data	= NULL,
	},
		{
		I2C_BOARD_INFO("es9219_2", 0x49),	//seven bit 0x49 eight bit 0x92
		.platform_data	= NULL,
	},
#endif
