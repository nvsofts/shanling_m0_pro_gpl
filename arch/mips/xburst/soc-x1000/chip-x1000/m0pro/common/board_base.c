...
#if defined(CONFIG_USB_DWC2) || defined(CONFIG_USB_JZ_DWC2) || defined(CONFIG_USB_JZ_DWC2_MODULE) || defined(CONFIG_USB_DWC2_DUAL)
...
//add by zxj
	...
	DEF_DEVICE(&moto320X290_device, 0, 0),
#endif
#ifdef CONFIG_LCD_BOEH0154_IC
	DEF_DEVICE(&h0154_ic_device, 0, 0),
#endif
...
static int __init board_base_init(void)
{
	...
	spi_register_board_info(jz_spi0_board_info, jz_spi0_devs_size);
     ...
     printk("i2c_register_board_info jz_i2c0_devs_size add by zxj\n");
#endif
	...
	printk("i2c_register_board_info jz_i2c1_devs  add by zxj\n");
#endif
