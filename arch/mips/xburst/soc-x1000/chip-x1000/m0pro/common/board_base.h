...
#if defined(CONFIG_USB_JZ_DWC2) || defined(CONFIG_USB_DWC2_DUAL)
...
extern struct platform_device moto320X290_device;
#endif
#ifdef CONFIG_LCD_BOEH0154_IC
extern struct platform_device h0154_ic_device;
#endif
