...
#define SIZE_UBOOT  0x40000    /* 256k */
#define SIZE_KERNEL 0x800000    /* 8M */
#define SIZE_RECOVERY   0x800000 /* 8M */
...
static struct jz_spi_support jz_spi_nand_support_table[] = {
    ...
    },
	{
		...
		.block_size = 128 * 1024,
		.size = 128 * 1024 * 1024,
		.column_cmdaddr_bits = 32, //24bit is wrong
	...
	{
        .id_manufactory = 0xef,
        .id_device = 0xaa,  //0xAA21
        .name = "W25N01GVxxIG",
        .page_size = 2 * 1024,
        .oobsize = 64, //64 byte one page
        .block_size = 128 * 1024,
        .size = 128 * 1024 * 1024,
        .column_cmdaddr_bits = 24,
