...
#if defined(CONFIG_USB_DWC2) || defined(CONFIG_USB_JZ_DWC2) || defined(CONFIG_USB_JZ_DWC2_MODULE) 
...
//add by zxj
	...
	//use this  sharp_tft480x800_device
	DEF_DEVICE(&sharp_tft480x800_device, 0, 0),
#endif
