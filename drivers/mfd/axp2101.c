...
static void axp20x_power_off(void)
{
	...
	regmap_write(axp20x_pm_power_off->regmap, AXP22X_PWR_OUT_CTRL1,
		     AXP20X_OFF);
...
{
	int ret;
	printk("==========fun[%s]==axp20x->irq[%d]==\n",__FUNCTION__,axp20x->irq);
