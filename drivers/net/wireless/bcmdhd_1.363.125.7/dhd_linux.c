...
bool dhd_update_fw_nv_path(dhd_info_t *dhdinfo)
{
	...
	int ver = __gpio_get_value(100);
	if(ver == 1) //check verion
	{
		fw = "/firmware/bcm43438-372sm.bin";
		nv = "/firmware/nvram_372sm.txt";
	}
	else
	{
		fw= "/firmware/fw_bcm43436b0.bin";
		nv = "/firmware/nvram_ap6236.txt";	
	}
#else	
	#ifdef CONFIG_BCMDHD_1_363_125_7_FW_PATH
		fw = CONFIG_BCMDHD_1_363_125_7_FW_PATH;
	#endif /* CONFIG_BCMDHD_1_363_125_7_FW_PATH */
	#ifdef CONFIG_BCMDHD_1_363_125_7_NVRAM_PATH
		nv = CONFIG_BCMDHD_1_363_125_7_NVRAM_PATH;	
	#endif /* CONFIG_BCMDHD_1_363_125_7_NVRAM_PATH */
#endif
	}
